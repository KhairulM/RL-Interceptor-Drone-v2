...
from torchrl.data import UnboundedContinuous, Composite
...
class Track(IsaacEnv):
    ...
    def _set_specs(self):
        ...
        self.observation_spec = Composite({
            "agents": {
                "observation": UnboundedContinuous((1, obs_dim)),
                "state": UnboundedContinuous((state_dim)),  # add motor speed
            }
        ...
        stats_spec = Composite({
            ...
            "tracking_error": UnboundedContinuous(1),
            "tracking_error_ema": UnboundedContinuous(1),
            "action_error_order1_mean": UnboundedContinuous(1),
            "action_error_order1_max": UnboundedContinuous(1),
            "action_error_order2_mean": UnboundedContinuous(1),
            "action_error_order2_max": UnboundedContinuous(1),
            "smoothness_mean": UnboundedContinuous(1),
            "smoothness_max": UnboundedContinuous(1),
            "drone_state": UnboundedContinuous(13),
            "reward_pos": UnboundedContinuous(1),
            "reward_up": UnboundedContinuous(1),
            "reward_spin": UnboundedContinuous(1),
            "reward_action_smoothness": UnboundedContinuous(1),
            "reward_action_norm": UnboundedContinuous(1),
            "reward_acc": UnboundedContinuous(1),
            "reward_jerk": UnboundedContinuous(1),
            "reward_action_smoothness_scale": UnboundedContinuous(1),
            "reward_action_norm_scale": UnboundedContinuous(1),
            "linear_v_max": UnboundedContinuous(1),
            "angular_v_max": UnboundedContinuous(1),
            "linear_a_max": UnboundedContinuous(1),
            "angular_a_max": UnboundedContinuous(1),
            "linear_jerk_max": UnboundedContinuous(1),
            "angular_jerk_max": UnboundedContinuous(1),
            "linear_snap_max": UnboundedContinuous(1),
            "linear_v_mean": UnboundedContinuous(1),
            "angular_v_mean": UnboundedContinuous(1),
            "linear_a_mean": UnboundedContinuous(1),
            "angular_a_mean": UnboundedContinuous(1),
            "linear_jerk_mean": UnboundedContinuous(1),
            "angular_jerk_mean": UnboundedContinuous(1),
            "linear_snap_mean": UnboundedContinuous(1),
            "obs_range": UnboundedContinuous(1),
        }).expand(self.num_envs).to(self.device)
        info_spec = Composite({
            "drone_state": UnboundedContinuous((self.drone.n, 13), device=self.device),
